...
import com.hanif.foodrecipe.model.ModelDetailRecipe
...
import kotlinx.android.synthetic.main.activity_detail_recipe.img_thumb
                    ...
                    override fun onResponse(response: JSONObject?) {
                        try {
                            ...
                            for (i in 0 until playerArray.length()) {
                                ...
                                val instruction = temp.getString("strInstructions")
                                tv_instructions.text = instruction

                                val category = temp.getString("strCategory")
                                val area = temp.getString("strArea")
                                tv_subtitle.text = "$category | $area"
                            ...
                            Toast.makeText(
                                ...
                                "Failed To Displaying Data", Toast.LENGTH_SHORT
                            ).show()
                        }
                    }
